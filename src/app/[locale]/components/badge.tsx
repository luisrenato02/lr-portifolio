export const Badge = () => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-5">
      ...
      <span
        className={`bg-yellow-100 text-yellow-800 text-xs font-medium  px-4 py-2 rounded-full dark:bg-yellow-900 dark:text-yellow-300 flex place-content-center`}
      >
        JavaScript
      </span>
      <span
      ...
      <span
        className={`bg-sky-100 text-sky-800 text-xs font-medium  px-4 py-2 rounded-full dark:bg-sky-900 dark:text-sky-300 flex place-content-center`}
      >
        Next.js
      </span>
      <span
        className={`bg-green-100 text-green-800 text-xs font-medium  px-4 py-2 rounded-full dark:bg-green-900 dark:text-green-300 flex place-content-center`}
      >
        Node.js
      </span>
      <span
